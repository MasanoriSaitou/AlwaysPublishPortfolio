...
export default function App() {
  ...
  const styles = {
    ...
    bar: (pct, color) => ({ width: `${Math.max(0, pct * 100)}%`, height: "100%", background: color, borderRadius: 8, transition: "width 0.4s" }),
    ...
    monsterBox: (shake) => ({ fontSize: 72, textAlign: "center", padding: "1.5rem", transition: "transform 0.1s", transform: shake ? "translateX(8px)" : "none" }),
    heroBox: (shake) => ({ fontSize: 56, textAlign: "center", transition: "transform 0.1s", transform: shake ? "translateX(-8px)" : "none" }),
